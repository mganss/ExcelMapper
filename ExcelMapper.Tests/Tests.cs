...
public class Tests
{
    ...
    public void VirtualSaveTest()
    {
        ...
        new ExcelMapper().Save("virtualsave.xlsx", [new ChildClass { Text = "test" }]);
    ...
    public void VirtualNoInheritSaveTest()
    {
        ...
        new ExcelMapper().Save("virtualnoinheritsave.xlsx", [new NoInheritChild { Text = "test" }]);
